...
-- admin
INSERT INTO user (id, name, email, password, age, gender, active) values (3, 'Administrador', 'admin@ifsp.edu.br', '$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.', 47, 'MASCULINO', 1);
